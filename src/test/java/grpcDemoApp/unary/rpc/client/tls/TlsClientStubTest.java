...
public class TlsClientStubTest {
	...
	public void setUp() throws Exception {
		...
		tlsClientStub = new TlsClientStub(channel);
	}
	...
	public void test_whenServerCall_thenReturnSuccessResponse() {
		...
		assertThat(tlsClientStub.serverCall("RoopTlsTest"), org.hamcrest.Matchers.instanceOf(Response.class));
	}

	@Test
	public void test_oneToOneCall_messageDeliveredToServer() {
		ArgumentCaptor<Request> requestCaptor = ArgumentCaptor.forClass(Request.class);
		tlsClientStub.serverCall("RoopTlsTest1");

		Mockito.verify(onetoOneServiceImplBase).oneToOneCall(requestCaptor.capture(),
				ArgumentMatchers.<StreamObserver<Response>>any());

		assertEquals("RoopTlsTest1", requestCaptor.getValue().getName());
	}
